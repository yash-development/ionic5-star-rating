...
const frameworkDelegate = require('./framework-delegate-58ba6b77.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          ...
          Promise.resolve().then(function () { return require('./input-shims-f01c253e.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
        }
